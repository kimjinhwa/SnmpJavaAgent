...
public class USM extends SNMPv3SecurityModel {
    ...
    /**
     * Adds an USM user to the internal user name table. The user's security name is used as userName.
     *
     * @param user
     *         the {@code UsmUser} to add.
     *
    ...
    /**
     * Adds an USM user to the internal user name table. The user's security name is used as userName. The storage type
    ...
    /**
     * Adds an USM user to the internal user name table and associates it with an authoritative engine ID. This user can
