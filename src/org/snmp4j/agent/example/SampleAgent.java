...
public class SampleAgent {
    ...
    public SampleAgent(Map<String, List<Object>> args) {
        ...
        List<?> dtlsVersions = args.get("dtls-version");
        if (dtlsVersions != null && (dtlsVersions.size() > 0)) {
            System.setProperty(SnmpConfigurator.P_DTLS_VERSION, (String) dtlsVersions.get(0));
        }
